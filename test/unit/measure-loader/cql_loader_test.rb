...
class CQLLoaderTest < Minitest::Test
  ...
  #     assert_equal 'PopulationCriteria1: Stratification 1', population_set.stratifications[0].title
  ...
  #     assert_equal 'PopulationCriteria1: Stratification 2', population_set.stratifications[1].title
